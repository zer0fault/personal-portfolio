...
public static class StaticDataProvider
{
    public static List<Domain.Entities.Settings> GetSettings() => new()
    {
        ...
        new Domain.Entities.Settings { Id = 4, Key = "CTAText", Value = "Get In Touch", Category = "Hero", LastModified = DateTime.Parse("2026-02-02T21:03:53.8656915") },
        new Domain.Entities.Settings { Id = 5, Key = "GitHubUrl", Value = "https://github.com/zer0fault", Category = "Hero", LastModified = DateTime.Parse("2026-02-02T21:03:53.8656917") },
